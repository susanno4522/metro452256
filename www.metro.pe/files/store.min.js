...
function sessionPlugin() {
	...
	function session_set(super_fn, key, val, expiration) {
		document.cookie = "sessionStore=session;domain=." + location.host + ";path=/";
		return super_fn()
	}

	function expire_get(super_fn, key) {
		_checkSession.call(this, key)
		return super_fn()
	}
	...
	function _checkSession(key) {
		if (!getCookie('sessionStore')) {
			this.raw.remove(key)
		}
	}
}

var localStorageOptions = (function (){
...
var sessionStore = store.createStore([localStorageOptions], [expirePlugin, sessionPlugin]);
